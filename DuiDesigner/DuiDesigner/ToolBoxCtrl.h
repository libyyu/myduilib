...
public:
	...
	CToolElement(const CString& strName, CString strClass,UINT nIDIcon);
...
public:
	...
	void SetClass(CString sClass) { m_strClass = sClass; }
	CToolElement* GetTool(CString sClass) const;
	CString GetClass() const { return m_strClass; }
...
public:
	...
	void SetCurSel(CString strClass,BOOL bRedraw=TRUE);
