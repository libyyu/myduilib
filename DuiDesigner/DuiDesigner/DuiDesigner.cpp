...
BOOL CUIDesignerApp::InitInstance()
{
	...
	DuiLib::CPaintManagerUI::SetRecordXMLAttribute(true);
...
int CUIDesignerApp::ExitInstance()
{
	...
	CPaintManagerUI::FreePlugin(_T("mgyUI_Plugin.dll"));
