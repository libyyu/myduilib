...
void CUITracker::Draw(CDC* pDC) const
{
	...
	//draw move handle
	if(m_nControlType== UITypeContainer)
	{
...
int CUITracker::HitTestHandles(CPoint point) const
{
	...
	return m_nControlType== UITypeControl?hitMiddle:hitNothing;   // no handle hit, but hit object (or object border)
}
