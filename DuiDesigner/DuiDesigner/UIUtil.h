...
#define  CSTRING_TO_ANI(x) StringConvertor::WideToAnsi(x)
#define  CSTRING_TO_UTF8(x) StringConvertor::WideToUtf8(x)
#define  UTF8_TO_CSTRING(x) CString(UTF8_TO_UNICODE_STR)
#else
#define UTF8_TO_UNICODE_STR(x) x
#define  CSTRING_TO_ANI(x) x
#define  CSTRING_TO_UTF8(x) x
#define  UTF8_TO_CSTRING(x) CString(x)
#endif
