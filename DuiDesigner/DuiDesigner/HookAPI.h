...
typedef TImageInfo* (WINAPI *pfnGetImageEx)(LPCTSTR pstrBitmap, LPCTSTR pstrType, DWORD mask, bool bUseHSL);
...
public:
	...
	static TImageInfo* WINAPI Hook_GetImageEx(LPCTSTR pstrBitmap, LPCTSTR pstrType, DWORD mask, bool bUseHSL);
