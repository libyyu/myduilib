...
CComboBodyUI::CComboBodyUI(CComboUI* pOwner) : CVerticalLayoutUI(), m_pOwner(pOwner)
{
    ASSERT(m_pOwner);
}
...
CComboUI::CComboUI() : CContainerUI(), m_pWindow(NULL), m_iCurSel(-1), m_uButtonState(0)
{
