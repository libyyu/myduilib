...
// MenuUI
const TCHAR* const kMenuUIClassName = _T("Menu");
const TCHAR* const kMenuUIInterfaceName = _T("Menu");
CMenuUI::CMenuUI() : CListUI()
{
	if (GetHeader() != NULL)
...
/////////////////////////////////////////////////////////////////////////////////////
//
REGIST_DUICONTROL(CMenuElementUI)
REGIST_DUICONTROL(CMenuUI)
...
CMenuElementUI::CMenuElementUI(): CListContainerElementUI(),
m_pWindow(NULL)
{
	m_cxyFixed.cy = 25;
