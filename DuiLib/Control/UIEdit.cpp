...
namespace DuiLib
{
	...
	CEditUI::CEditUI() : CLabelUI(), m_pWindow(NULL), m_uMaxChar(255), m_bReadOnly(false),
	...
	void CEditUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
		...
		else if (_tcscmp(pstrName, _T("prompt")) == 0) SetPrompt(pstrValue); //2018/6/10
