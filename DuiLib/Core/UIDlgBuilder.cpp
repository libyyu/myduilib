...
namespace DuiLib {
    ...
    CControlUI* CDialogBuilder::Create(IDialogBuilderCallback* pCallback, CPaintManagerUI* pManager, CControlUI* pParent)
    {
		...
		return _Create(&root, pManager, pParent);
    }

    CControlUI* CDialogBuilder::Create(CMarkup* xml, LPCTSTR type /*= NULL*/, IDialogBuilderCallback* pCallback/* = NULL*/, CPaintManagerUI* pManager/* = NULL*/, CControlUI* pParent/* = NULL*/)
    {
		m_pCallback = pCallback;
		m_pstrtype = type;
    ...
    CControlUI* CDialogBuilder::_Create(CMarkupNode* root, CPaintManagerUI* pManager/* = NULL*/, CControlUI* pParent/* = NULL*/)
    {
		if (pManager) {
