...
class DUILIB_API CMarkup : public CDuiBaseObject
{
...
private:
	bool _BeginParse(CResource* ResLoader, int encoding = XMLFILE_ENCODING_UTF8);
    bool _Parse();
...
class DUILIB_API CMarkupNode : public CDuiBaseObject
{
