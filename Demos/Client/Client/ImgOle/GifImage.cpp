...
namespace DuiLib
{
	...
	BOOL CGifImage::LoadFromFile(LPCTSTR pszFileName)
	{
		...
		do
		{
			CResourceManager::Instance()->LoadAsset(pszFileName, NULL, &pData, &dwSize);
		} while (0);
		...
		BOOL ret = LoadFromBuffer(pData, dwSize);
