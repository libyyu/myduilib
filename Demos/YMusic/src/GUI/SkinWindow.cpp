...
void YSkinWindow::LoadSysSkin()
{
	...
	for (int i=0;i< CSysSkinLayoutUI::SysRowNum;++i)
	{
		...
		sImage[0].Format(_T("res/style/sys/%d/%d.jpg"),i+1,1);
		sImage[1].Format(_T("res/style/sys/%d/%d.jpg"),i+1,2);
		sImage[2].Format(_T("res/style/sys/%d/%d.jpg"),i+1,3);
		sImage[3].Format(_T("res/style/sys/%d/%d.jpg"),i+1,4);
		sImage[4].Format(_T("res/style/sys/%d/%d.jpg"),i+1,5);
...
{
	{
		...
		for (int i=0;i< CMySkinLayoutUI::MyRowNum;++i)
		{
			...
			sImage[0].Format(_T("res/style/custom/%d/%d.jpg"),i+1,1);
			sImage[1].Format(_T("res/style/custom/%d/%d.jpg"),i+1,2);
			sImage[2].Format(_T("res/style/custom/%d/%d.jpg"),i+1,3);
			sImage[3].Format(_T("res/style/custom/%d/%d.jpg"),i+1,4);
			sImage[4].Format(_T("res/style/custom/%d/%d.jpg"),i+1,5);
