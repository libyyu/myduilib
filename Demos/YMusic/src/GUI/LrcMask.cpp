...
LRESULT CLrcMask::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	...
	if(!RegisterSkin(_T("xml/lrc.xml"), 0, this))
		return 0;
	DuiLib::CDuiRect rc;
	DuiLib::CDuiRect rect;
	//GetSystemMetrics(SM_CYFULLSCREEN)�������Ļ�ͻ�����������ȷ;by daodao 2012-11-27;
	...
	ModifyStyleEx(WS_EX_APPWINDOW,/*WS_EX_TRANSPARENT|*/WS_EX_LAYERED|WS_EX_TOOLWINDOW);//����WS_EX_TRANSPARENT��չ���� 
...
void CLrcMask::Notify(DuiLib::TNotifyUI& msg)
{
...
LRESULT CLrcMask::OnNCMouseMove(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	...
	DuiLib::CDuiRect rect;
	GetWindowRect(&rect);
	DuiLib::CDuiPoint point = DuiLib::CDuiPoint(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
	RECT sizebox;
...
void CLrcMask::DrawBkMask()
{
	...
	DuiLib::CDuiPoint dstPt(0,0);
	DuiLib::CDuiPoint winPt(rtWnd.left,rtWnd.top);
	DuiLib::CDuiSize size(rc.GetWidth(),rc.GetHeight());
