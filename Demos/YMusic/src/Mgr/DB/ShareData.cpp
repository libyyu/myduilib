...
DuiLib::CDuiString CSongInfo::GetSongKey()const
{
	return m_sSongKey;
}
void CSongInfo::SetSongKey(const DuiLib::CDuiString& sSongKey)
{
	m_sSongKey = sSongKey;
}
DuiLib::CDuiString CSongInfo::GetSongName()const
{
	return m_sSongName;
}
void CSongInfo::SetSongName(const DuiLib::CDuiString& sSongName)
{
	m_sSongName = sSongName;
}
DuiLib::CDuiString CSongInfo::GetAlbumName()const
{
	return m_sAlbumName;
}
void CSongInfo::SetAblumName(const DuiLib::CDuiString& sAblumName)
{
	m_sAlbumName=sAblumName;
}
DuiLib::CDuiString CSongInfo::GetArtistName()const
{
	return m_sArtistName;
}
void CSongInfo::SetArtistName(const DuiLib::CDuiString& sArtistName)
{
	m_sArtistName = sArtistName;
}
DuiLib::CDuiString CSongInfo::GetRealArtistName()const
{
	return m_sRealArtistName;
}
void CSongInfo::SetRealArtistName(const DuiLib::CDuiString& sRealArtistName)
{
	m_sRealArtistName = sRealArtistName;
}
DuiLib::CDuiString CSongInfo::GetLocalPath()const
{
	return m_sLocalPath;
}
void CSongInfo::SetLocalPath(const DuiLib::CDuiString& sPath)
{
	m_sLocalPath = sPath;
}
DuiLib::CDuiString CSongInfo::GetCoverLocalPath()const
{
	return m_sCoverLocalPath;
}
void CSongInfo::SetCoverLocalPath(const DuiLib::CDuiString& sPath)
{
	m_sCoverLocalPath = sPath;
}
DuiLib::CDuiString CSongInfo::GetLrcLocalPath()const
{
	return m_sLrcLocalPath;
}
void CSongInfo::SetLrcLocalPath(const DuiLib::CDuiString& sPath)
{
	m_sLrcLocalPath = sPath;
}
DuiLib::CDuiString CSongInfo::GetListenFileUrl()const
{
	return m_sListenFileUrl;
}
void CSongInfo::SetListenFileUrl(const DuiLib::CDuiString& sUrl)
{
	m_sListenFileUrl = sUrl;
}
void CSongInfo::SetFileExt(const DuiLib::CDuiString& sExt)
{
	m_sFileExt = sExt;
}
DuiLib::CDuiString CSongInfo::GetFileExt() const
{
	return m_sFileExt;
}
DuiLib::CDuiString CSongInfo::GetMD5()const
{
	return m_sMD5;
}
void CSongInfo::SetMD5(const DuiLib::CDuiString& sMD5)
{
	m_sMD5 = sMD5;
}
DuiLib::CDuiString CSongInfo::GetCoverUrl()const
{
	return m_sCoverUrl;
}
void CSongInfo::SetCoverUrl(const DuiLib::CDuiString& sUrl)
{
	m_sCoverUrl = sUrl;
}
DuiLib::CDuiString CSongInfo::GetLrcUrl()const
{
	return m_sLrcUrl;
}
void CSongInfo::SetLrcUrl(const DuiLib::CDuiString& sUrl)
{
	m_sLrcUrl = sUrl;
}
...
CPlayListInfo::CPlayListInfo(const DuiLib::CDuiString& sPlayListName,CPlayListInfo::PlayListType eType)
{
	m_nLocalID = 0;
	m_nID = 0;
...
DuiLib::CDuiString CPlayListInfo::GetName()const
{
	return m_sName;
}
void CPlayListInfo::SetName(const DuiLib::CDuiString& sName)
{
	m_sName = sName;
}
DuiLib::CDuiString CPlayListInfo::GetComment()const
{
	return m_sComment;
}
void CPlayListInfo::SetComment(const DuiLib::CDuiString& sComment)
{
	m_sComment = sComment;
}
...
DuiLib::CDuiString CFavInfo::GetFavName()const
{
	return m_sName;
}
void CFavInfo::SetFavName(const DuiLib::CDuiString& sName)
{
	m_sName = sName;
}
