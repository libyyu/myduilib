...
BOOL CClientSocket::MyGetSockName(CDuiString& rSocketAddress, UINT& rSocketPort)
{
	CString address;
...
BOOL CClientSocket::MyGetPeerName(CDuiString& rSocketAddress, UINT& rSocketPort)
{
	CString address;
