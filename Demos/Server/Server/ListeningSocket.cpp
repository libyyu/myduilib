...
BOOL CListeningSocket::MyGetSockName(CDuiString& rSocketAddress, UINT& rSocketPort)
{
	CString address;
...
BOOL CListeningSocket::MyGetPeerName(CDuiString& rSocketAddress, UINT& rSocketPort)
{
	CString address;
