...
class CUIShadowWnd : public DuiLib::CWindowWnd
{
private:
    bool m_bNeedUpdate;
...
class CMyMenuWnd : public DuiLib::CWindowWnd, public DuiLib::INotifyUI
{
public:
    CMyMenuWnd() : m_pOwner(NULL), m_pShadowWnd(NULL) { };
    ...
    LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
    {
		...
		DuiLib::CControlUI* pRoot = builder.Create(_T("menu.xml"), (UINT)0, NULL, &m_pm);
    ...
    LRESULT OnKillFocus(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
    {
        if( (HWND)wParam == m_hWnd ) bHandled = TRUE;
			...
			DuiLib::CWindowWnd::HandleMessage(uMsg, wParam, lParam);
            ::SetFocus( m_hWnd );
            bHandled = TRUE;
        }
        else {
