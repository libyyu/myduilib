...
{
    HWND hWnd;
	DuiLib::CListUI* pList;
	DuiLib::CButtonUI* pSearch;
	DuiLib::CDuiString tDomain;
};

#include "MenuWnd.h"

class ListMainForm : public  DuiLib::CWindowWnd, public  DuiLib::INotifyUI, public  DuiLib::IListCallbackUI
{
public:
    ListMainForm() {
    };
    ...
    void Init() 
    {
        ...
        m_pSearch = static_cast< DuiLib::CButtonUI*>(m_pm.FindControl(_T("btn")));
    }
    ...
    static DWORD WINAPI Search(LPVOID lpParameter)
    {
        try
        {
			...
			DuiLib::CListUI* pList = prama->pList;
			DuiLib::CButtonUI* pSearch = prama->pSearch;
			DuiLib::CDuiString tDomain = prama->tDomain;
            //-------------------------------------
            /*
            * 添加数据循环
            */
    ...
    void OnSearch()
    {
		...
		DuiLib::CListUI* pList = static_cast< DuiLib::CListUI*>(m_pm.FindControl(_T("domainlist")));
		DuiLib::CEditUI* pEdit = static_cast< DuiLib::CEditUI*>(m_pm.FindControl(_T("input")));
        pEdit->SetEnabled(false);
		DuiLib::CDuiString input = pEdit->GetText();
    ...
    */
    void GetItemText(DuiLib::CControlUI* pControl, int iIndex, int iSubItem, DuiLib::CDuiString& text)
    {
    ...
    void Notify(DuiLib::TNotifyUI& msg)
    {
        ...
        else if( msg.sType == _T("itemactivate") ) 
        {
			...
			DuiLib::CDuiString sMessage = _T("Click: ");;
#ifdef _UNICODE		
            int iLen = domain[iIndex].length();
            LPWSTR lpText = new WCHAR[iLen + 1];
            ::ZeroMemory(lpText, (iLen + 1) * sizeof(WCHAR));
        ...
        else if(msg.sType == _T("menu")) 
        {
            ...
            CMyMenuWnd* pMenu = new CMyMenuWnd();
			...
			DuiLib::CListUI* pList = static_cast< DuiLib::CListUI*>(msg.pSender);
    ...
    LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
    {
		...
		DuiLib::CControlUI* pRoot = builder.Create(_T("skin.xml"), (UINT)0, NULL, &m_pm);
