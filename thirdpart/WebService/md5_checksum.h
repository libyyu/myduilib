...
*****************************************************************************************/
struct WEBSERVICE_API md5_hash_value
{
...
struct WEBSERVICE_API md5_hash_less : public std::binary_function<const md5_hash_value&,
...
class WEBSERVICE_API md5_checksum
{
public:
...
#else
    static std::string get_md5(const char* p_file_path);
    static std::string get_md5(const char* p_file_path, unsigned int n_begin, unsigned int n_len);
#endif
