...
#define F_CONSOLE(LEVEL) \
	_FStd(FConsoleFinisher)() = _FStd(FConsole)(_FStd(FLIB_LOGLEVEL)::FLIB_LOGLEVEL_##LEVEL, __FILE__, __LINE__)

#define F_CONSOLE_TRACE  \
	_FStd(FConsole) f_console_trace(_FStd(FLIB_LOGLEVEL)::FLIB_LOGLEVEL_TRACE, __FILE__, __LINE__);  \
	_FStd(FConsoleTraceFunction) f_consoleTraceFunction(f_console_trace, __FUNCTION__, __FILE__, __LINE__); \
